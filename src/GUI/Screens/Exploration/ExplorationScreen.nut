...
::ScreenManager.Screens[Screen.EXPLORATION_SCREEN] = class extends ::Screen{
    ...
    FoundItemIconsManager = class{
        ...
        function addItem(itemDef){
            ...
            //Create new widget
            local newWidget = ::GuiWidgets.FoundItemWidget(mParentWindow_, itemDef, 0.3, 0);
    ...
    function busCallback(event, data){
        if(event == ExplorationBusEvents.TRIGGER_ITEM){
            ...
            if(data.type == FoundObjectType.ITEM){
                ...
                ::EffectManager.displayEffect(::EffectManager.EffectData(Effect.SPREAD_COIN_EFFECT, {"cellSize": 100, "coinScale": 10, "numCoins": 2, "start": worldPos, "end": endPos, "money": 100}));
            }
