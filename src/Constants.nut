...
const EFFECT_WINDOW_CAMERA_Z = 200;

const SCREENS_START_Z = 40;
const POPUPS_START_Z = 60;
const WIDGET_SAFE_FOR_BILLBOARD_Z = 80;
...
const PLAYER_COMPASS_DISTANCE = 32.0;
...
enum Event{
    ...
    PLAYER_DIRECTING_CHANGED = 1031,

    OVERWORLD_SELECTED_REGION_CHANGED = 1032,
    EXPLORATION_SCREEN_HIDE_WIDGETS_FINISHED = 1033,

    BANK_MONEY_CHANGED = 1034,
    STORAGE_CONTENTS_CHANGED = 1035,

    SPLASH_SCREEN_FINISHED = 1036,

    MINIMAP_PLAYER_POSITION_CHANGED = 1037,
    MINIMAP_CAMERA_DIRECTION_CHANGED = 1038,
    MINIMAP_PLAYER_DIRECTION_CHANGED = 1039,

    ARTIFACT_COLLECTED = 1040,
...
enum Effect{
    ...
    COLLECTABLE_OPEN_EFFECT,
    COLLECTABLE_ITEM_EFFECT,
