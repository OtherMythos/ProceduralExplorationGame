...
::ExplorationLogic <- class{
    ...
    */
    ...
    function notifyFoundEXPOrb(){
        ...
        ::EffectManager.displayEffect(::EffectManager.EffectData(Effect.LINEAR_EXP_ORB_EFFECT, {"numOrbs": 1, "start": worldPos, "end": endPos, "orbScale": 30}));
    }
    ...
    function givePlayerOrb(orbId){
        ...
        if(newlyFound){
            ...
            mCurrentWorld_.notifyNewOrbFound();
            pauseExploration();
        }else{
