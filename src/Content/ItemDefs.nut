...
::Items[ItemId.MAGMA_SHROOM] = ItemDef("Magma Shroom", "A peculiar mushroom that radiates heat", "mushrooms.mushroom.magma.voxMesh", "item_mushroom1", ItemType.EAT, 10, null, EquippableId.NONE);
...
::Items[ItemId.SAND_URN] = ItemDef("Sand Urn", "An ancient urn that has travelled across the desert sands. It contains something mysterious.", "simpleSword.voxMesh", "item_simpleSword", ItemType.SAND_URN, 0, null, EquippableId.NONE);
