...
::Items[ItemId.BLUE_ORE] = ItemDef("Blue Ore", "A chunk of blue ore mined from a rock.", "ore.blueOre.voxMesh", ItemType.ITEM, 5, null, EquippableId.NONE, ItemEquipTransformType.NONE, 1.6);

::Items[ItemId.NOTE_SCRAP] = ItemArtifactDef("Note Scrap", "A scrap of paper found inside the message in a bottle.", "readables.noteScrap.voxMesh", ItemType.LORE_CONTENT, 0, null, EquippableId.NONE);
::Items[ItemId.NOTE_SCRAP].mGivenData = true;
//-------------------------------
