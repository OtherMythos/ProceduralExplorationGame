...
::Items[ItemId.BOOK_OF_GOBLIN_STORIES] = ItemDef("Book of Goblin Stories", "A crudely written tomb of popular goblin stories", "boneMace.voxMesh", ItemType.LORE_CONTENT, 0, "BookOfGoblinTales.nut", EquippableId.NONE);
::Items[ItemId.APPLE] = ItemDef("Apple", "Fibrous fruit", "apple.voxMesh", ItemType.EAT, 5, null, EquippableId.NONE);
::Items[ItemId.COCONUT] = ItemDef("Coconut", "Weirdly milky for a fruit", "apple.voxMesh", ItemType.EAT, 5, null, EquippableId.NONE);
::Items[ItemId.RED_BERRIES] = ItemDef("Red Berries", "Red and fruity", "apple.voxMesh", ItemType.EAT, 5, null, EquippableId.NONE);
...
::Items[ItemId.NOTE_SCRAP] = ItemDef("Note Scrap", "A scrap of paper found inside the message in a bottle.", null, ItemType.LORE_CONTENT, 0, null, EquippableId.NONE);
