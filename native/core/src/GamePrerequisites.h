...
namespace ProceduralExplorationGameCore{
    ...
    static const PathId INVALID_PATH_ID = 0xFF;
    ...
    //A single packed 32-bit seed. Layout: bits[31:16] = base, bits[15:8] = moisture, bits[7:0] = variation.
    typedef AV::uint32 SeedValue;
