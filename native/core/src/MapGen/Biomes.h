...
namespace ProceduralExplorationGameCore{
    ...
    public:
        ...
        Biome(DetermineVoxFunction voxFunction, PlaceObjectFunction placementFunction, DetermineAltitudeFunction altitudeFunction, FinalVoxChangeFunction finalVoxFunction);
        ~Biome();
