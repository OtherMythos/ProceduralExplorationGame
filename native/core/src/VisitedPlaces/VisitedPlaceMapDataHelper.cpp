...
namespace ProceduralExplorationGameCore{
    ...
    bool VisitedPlaceMapDataHelper::voxeliseToTerrainMeshes(const std::string& meshName, Ogre::MeshPtr* outMesh, AV::uint32 x, AV::uint32 y, AV::uint32 width, AV::uint32 height){
